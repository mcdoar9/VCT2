...
movie = visual.MovieStim(
    win=win, name='movie',
    filename=u'/Users/MRIPsychology/Documents/MATLAB/Experiments/Child/nemo_firstdayofschool.mp4',
...
while continueRoutine and routineTimer.getTime() > 0:
    ...
    frameRemains = 0.0 + 344- win.monitorFramePeriod * 0.75  # most of one frame period left
